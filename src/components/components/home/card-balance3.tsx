...
export const CardBalance3 = () => {
  return (
    <Card className="xl:max-w-sm bg-success-300 rounded-xl shadow-md px-3 w-full">
      <CardBody className="py-5">
        <div className="flex gap-2.5">
          <Community />
          <div className="flex flex-col">
            <span className="text-white">Frauds Detected</span>
            <span className="text-white text-xs">+1311</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-6">
          <div>
            <div>
              ...
              <span className="text-xs">6,930</span>
            </div>
